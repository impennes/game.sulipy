...
@Component({
  selector: 'app-gombsor-teszt',
  templateUrl: './gombsor-teszt.component.html',
  styleUrls: ['./gombsor-teszt.component.css'],
})
export class GombsorTesztComponent implements OnInit {
